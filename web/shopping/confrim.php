...
<html lang="en">
  ...
  <body>
    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-12">
                <h1>Thank you <?php echo $_SESSION['firstName'] . " " . $_SESSION['lastName']; ?></h1>
                <p>You have finshed the order for <?php  echo $_SESSION['name']; ?></p>
                <p> <img src="<?php echo $_SESSION['img']; ?>" alt="<?php  echo $_SESSION['name']; ?>" style="width:200px;"> </p>
                <h4>Shipping to</h4>
